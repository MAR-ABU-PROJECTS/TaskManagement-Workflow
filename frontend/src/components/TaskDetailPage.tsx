    ...
    <div className="flex flex-1 flex-col px-4 p-6">
      ...
      <div className="flex items-center mb-3">
        <div className="flex items-center gap-3 flex-1">
          <button className="outline-none" onClick={() => router.back()}>
            <ChevronLeft />
          </button>
          <h1 className="text-lg font-semibold">Design homepage mockup</h1>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Create a high-fidelity mockup for the new homepage design. The
                  mockup should include the hero section.
                </p>
              </CardContent>
            </Card>
