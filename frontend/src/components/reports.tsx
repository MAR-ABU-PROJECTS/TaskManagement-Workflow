                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={projectCompletionData}>
                      ...
                      <Line type="monotone" dataKey="inProgress" stroke="hsl(var(--chart-2))" strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
                </ChartContainer>
              </CardContent> */}
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={teamPerformanceData}>
                      ...
                      <ChartTooltip content={<ChartTooltipContent />} />
                      <Legend />
                      <Bar dataKey="velocity" fill="hsl(var(--chart-1))" radius={[4, 4, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </ChartContainer> */}
							</CardContent>
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={issueResolutionData}>
                      ...
                      <ChartTooltip content={<ChartTooltipContent />} />
                      <Legend />
                      <Bar dataKey="resolved" fill="hsl(var(--chart-1))" radius={[4, 4, 0, 0]} />
										...
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground mt-1">
													Engineering team is
													exceeding velocity targets
													by 15%. Consider sharing
													their workflow with other
													teams.
												</p>
											</div>
										</div>
									...
									<div className="rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4">
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground mt-1">
													12 tasks are currently
													blocked. Review dependencies
									...
									<div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground mt-1">
													Marketing team has capacity
													for 8 more tasks this sprint
