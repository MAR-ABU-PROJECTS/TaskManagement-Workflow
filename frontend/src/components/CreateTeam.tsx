        ...
        <div className="mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set up a new team to organize your projects and collaborate with
                members
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Add a brief description of what this team does
                  </p>
                </div>

                {/* Action Buttons */}
                <div className="flex gap-3 pt-4">
                  <Button type="submit" disabled={!teamName || isLoading}>
